...
def process_single_image(image_path, save_to_results=False):
    ...
    if kwh_status != 'kwh_jelas':
        ...
        # Choose save location based on save_to_results parameter
...
def update_database(blth, idpel, ket, sai, anotasi, existing_data=None):
    ...
    try:
        ...
        # Ambil SAHLWBP dari file excel jika ada
            ...
            for index, row in df.iterrows():
                ...
                try:
                    ...
                    if result_image_path:
                        ...
                        results.append({
                            'filename': f"{idpel}_{blth}.jpg", 
                            'result_text': result_text or 'Gagal memproses gambar.', 
                            'result_image_url': ''
                        })
